...
- (void)setupNavigationBar
{
    ...
    UIBarButtonItem *moreItem = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"TSDemo_VoiceRecognition.bundle/ic_more_white"]
                                                                 style:UIBarButtonItemStylePlain
                                                                target:self
    ...
    */
    ...
    UIBarButtonItem *copyItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"ActionSheetCopy", @"") style:UIBarButtonItemStylePlain target:self action:@selector(copyAll)];
...
- (UIToolbar *)toolbar {
    if (_toolbar == nil) {
        ...
        UIBarButtonItem *voiceBarButton = [[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"TSDemo_VoiceRecognition.bundle/micro_small"] style:UIBarButtonItemStylePlain target:self action:@selector(useVoiceInput)];
