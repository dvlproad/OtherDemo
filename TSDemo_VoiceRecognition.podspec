Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://gitee.com/dvlproad/UIKit-Guide-iOS.git", :tag => "TSDemo_VoiceRecognition_0.1.4" }
  ...
  s.source_files = "TSDemo_VoiceRecognition/**/*.{h,m}"
  s.resource_bundle = {
    'TSDemo_VoiceRecognition' => ['TSDemo_VoiceRecognition/**/*.{xcassets}', 'TSDemo_VoiceRecognition/**/*.{bundle,mp4}'] # TSDemo_VoiceRecognition 为生成boudle的名称，可以随便起，但要记住，库里要用
  }
  #多个依赖就写多行
